...
<head>
    ...
    <!-- Title -->
    <title>Sistema de Venta Básico</title>
...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                <a href="./" class="logo-icon"><span class="logo-text">HORNITO</span></a>
               <!-- <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <img src="../assets/images/logo.png">
                        <span class="activity-indicator"></span>
                        <span class="user-info-text">Hornito<br><span class="user-state-info">0.1v</span></span>
                    </a>
                </div>-->
            </div>
            <div class="app-menu">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item hidden-on-mobile">     
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown">
                                               <span><?php echo $nombre; ?> </span> <i class="material-icons-outlined">person_add</i>
